...
(function(root, factory) {
  ...
  describe('GetMyFeesEstimateResult', function() {
    it('should create an instance of GetMyFeesEstimateResult', function() {
      // uncomment below and update the code to test GetMyFeesEstimateResult
      //var instane = new SellingPartnerApiForProductFees.GetMyFeesEstimateResult();
    ...
    it('should have the property feesEstimateResult (base name: "FeesEstimateResult")', function() {
      // uncomment below and update the code to test the property feesEstimateResult
      //var instane = new SellingPartnerApiForProductFees.GetMyFeesEstimateResult();
