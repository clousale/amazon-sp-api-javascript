...
(function(root, factory) {
  ...
  describe('PartneredSmallParcelDataOutput', function() {
    it('should create an instance of PartneredSmallParcelDataOutput', function() {
      // uncomment below and update the code to test PartneredSmallParcelDataOutput
      //var instane = new SellingPartnerApiForFulfillmentInbound.PartneredSmallParcelDataOutput();
