...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.TrackingAddress();
  });
  ...
  describe('TrackingAddress', function() {
    it('should create an instance of TrackingAddress', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentOutbound.TrackingAddress();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.TrackingAddress);
    });
