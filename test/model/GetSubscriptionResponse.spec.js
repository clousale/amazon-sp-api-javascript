...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForNotifications.GetSubscriptionResponse();
  });
  ...
  describe('GetSubscriptionResponse', function() {
    it('should create an instance of GetSubscriptionResponse', function() {
      ...
      //var instane = new SellingPartnerApiForNotifications.GetSubscriptionResponse();
      //expect(instance).to.be.a(SellingPartnerApiForNotifications.GetSubscriptionResponse);
    });
