...
(function(root, factory) {
  ...
  describe('PrepInstruction', function() {
    it('should create an instance of PrepInstruction', function() {
      // uncomment below and update the code to test PrepInstruction
      //var instane = new SellingPartnerApiForFulfillmentInbound.PrepInstruction();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.PrepInstruction);
    });
