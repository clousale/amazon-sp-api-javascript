...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.ReturnAuthorization();
  });
  ...
  describe('ReturnAuthorization', function() {
    it('should create an instance of ReturnAuthorization', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentOutbound.ReturnAuthorization();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.ReturnAuthorization);
    });
