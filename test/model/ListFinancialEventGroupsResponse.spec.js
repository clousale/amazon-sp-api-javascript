...
(function(root, factory) {
  ...
  describe('ListFinancialEventGroupsResponse', function() {
    it('should create an instance of ListFinancialEventGroupsResponse', function() {
      // uncomment below and update the code to test ListFinancialEventGroupsResponse
      //var instane = new SellingPartnerApiForFinances.ListFinancialEventGroupsResponse();
