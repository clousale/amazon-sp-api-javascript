...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.CreateFulfillmentOrderRequest();
  });
  ...
  describe('CreateFulfillmentOrderRequest', function() {
    it('should create an instance of CreateFulfillmentOrderRequest', function() {
      // uncomment below and update the code to test CreateFulfillmentOrderRequest
      //var instane = new SellingPartnerApiForFulfillmentOutbound.CreateFulfillmentOrderRequest();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.CreateFulfillmentOrderRequest);
    });
