...
(function(root, factory) {
  ...
  describe('InvalidSKU', function() {
    it('should create an instance of InvalidSKU', function() {
      // uncomment below and update the code to test InvalidSKU
      //var instane = new SellingPartnerApiForFulfillmentInbound.InvalidSKU();
