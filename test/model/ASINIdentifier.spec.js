...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForCatalogItems.ASINIdentifier();
  });
  ...
  describe('ASINIdentifier', function() {
    it('should create an instance of ASINIdentifier', function() {
      ...
      //var instane = new SellingPartnerApiForCatalogItems.ASINIdentifier();
      //expect(instance).to.be.a(SellingPartnerApiForCatalogItems.ASINIdentifier);
    });
