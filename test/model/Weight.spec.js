...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentInbound.Weight();
  });
  ...
  describe('Weight', function() {
    it('should create an instance of Weight', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentInbound.Weight();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.Weight);
    });
