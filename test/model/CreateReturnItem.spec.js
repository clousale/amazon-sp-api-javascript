...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.CreateReturnItem();
  });
  ...
  describe('CreateReturnItem', function() {
    it('should create an instance of CreateReturnItem', function() {
      // uncomment below and update the code to test CreateReturnItem
      //var instane = new SellingPartnerApiForFulfillmentOutbound.CreateReturnItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.CreateReturnItem);
    });
