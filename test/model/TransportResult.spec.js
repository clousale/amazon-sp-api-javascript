...
(function(root, factory) {
  ...
  describe('TransportResult', function() {
    it('should create an instance of TransportResult', function() {
      // uncomment below and update the code to test TransportResult
      //var instane = new SellingPartnerApiForFulfillmentInbound.TransportResult();
    ...
    it('should have the property transportStatus (base name: "TransportStatus")', function() {
      // uncomment below and update the code to test the property transportStatus
      //var instane = new SellingPartnerApiForFulfillmentInbound.TransportResult();
