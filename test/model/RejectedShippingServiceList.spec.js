...
(function(root, factory) {
  ...
  describe('RejectedShippingServiceList', function() {
    it('should create an instance of RejectedShippingServiceList', function() {
      // uncomment below and update the code to test RejectedShippingServiceList
      //var instane = new SellingPartnerApiForMerchantFulfillment.RejectedShippingServiceList();
