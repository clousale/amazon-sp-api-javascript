...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.UpdateFulfillmentOrderItem();
  });
  ...
  describe('UpdateFulfillmentOrderItem', function() {
    it('should create an instance of UpdateFulfillmentOrderItem', function() {
      // uncomment below and update the code to test UpdateFulfillmentOrderItem
      //var instane = new SellingPartnerApiForFulfillmentOutbound.UpdateFulfillmentOrderItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.UpdateFulfillmentOrderItem);
    });
