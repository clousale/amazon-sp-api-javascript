...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.DeliveryWindow();
  });
  ...
  describe('DeliveryWindow', function() {
    it('should create an instance of DeliveryWindow', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentOutbound.DeliveryWindow();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.DeliveryWindow);
    });
