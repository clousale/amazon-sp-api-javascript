...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.FulfillmentShipmentItem();
  });
  ...
  describe('FulfillmentShipmentItem', function() {
    it('should create an instance of FulfillmentShipmentItem', function() {
      // uncomment below and update the code to test FulfillmentShipmentItem
      //var instane = new SellingPartnerApiForFulfillmentOutbound.FulfillmentShipmentItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.FulfillmentShipmentItem);
    });
