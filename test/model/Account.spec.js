...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForShipping.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instane = new SellingPartnerApiForShipping.Account();
      //expect(instance).to.be.a(SellingPartnerApiForShipping.Account);
    });
