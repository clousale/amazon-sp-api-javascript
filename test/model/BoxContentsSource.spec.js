...
(function(root, factory) {
  ...
  describe('BoxContentsSource', function() {
    it('should create an instance of BoxContentsSource', function() {
      // uncomment below and update the code to test BoxContentsSource
      //var instane = new SellingPartnerApiForFulfillmentInbound.BoxContentsSource();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.BoxContentsSource);
    });
