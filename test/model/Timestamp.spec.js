...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.Timestamp();
  });
  ...
  describe('Timestamp', function() {
    it('should create an instance of Timestamp', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentOutbound.Timestamp();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.Timestamp);
    });
