...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForOrders.GetOrderResponse();
  });
  ...
  describe('GetOrderResponse', function() {
    it('should create an instance of GetOrderResponse', function() {
      ...
      //var instane = new SellingPartnerApiForOrders.GetOrderResponse();
      //expect(instance).to.be.a(SellingPartnerApiForOrders.GetOrderResponse);
    });
