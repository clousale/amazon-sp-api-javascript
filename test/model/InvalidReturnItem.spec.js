...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.InvalidReturnItem();
  });
  ...
  describe('InvalidReturnItem', function() {
    it('should create an instance of InvalidReturnItem', function() {
      // uncomment below and update the code to test InvalidReturnItem
      //var instane = new SellingPartnerApiForFulfillmentOutbound.InvalidReturnItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.InvalidReturnItem);
    });
    ...
    it('should have the property invalidItemReason (base name: "InvalidItemReason")', function() {
      // uncomment below and update the code to test the property invalidItemReason
      //var instane = new SellingPartnerApiForFulfillmentOutbound.InvalidReturnItem();
      //expect(instance).to.be();
    });
