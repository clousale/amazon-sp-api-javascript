...
(function(root, factory) {
  ...
  describe('EventCode', function() {
    it('should create an instance of EventCode', function() {
      // uncomment below and update the code to test EventCode
      //var instane = new SellingPartnerApiForFulfillmentOutbound.EventCode();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.EventCode);
    });
