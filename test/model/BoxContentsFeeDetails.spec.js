...
(function(root, factory) {
  ...
  describe('BoxContentsFeeDetails', function() {
    it('should create an instance of BoxContentsFeeDetails', function() {
      // uncomment below and update the code to test BoxContentsFeeDetails
      //var instane = new SellingPartnerApiForFulfillmentInbound.BoxContentsFeeDetails();
    ...
    it('should have the property feePerUnit (base name: "FeePerUnit")', function() {
      // uncomment below and update the code to test the property feePerUnit
      //var instane = new SellingPartnerApiForFulfillmentInbound.BoxContentsFeeDetails();
      //expect(instance).to.be();
    });
