...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.CODSettings();
  });
  ...
  describe('CODSettings', function() {
    it('should create an instance of CODSettings', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentOutbound.CODSettings();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.CODSettings);
    });
