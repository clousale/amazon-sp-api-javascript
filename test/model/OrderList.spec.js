...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForOrders.OrderList();
  });
  ...
  describe('OrderList', function() {
    it('should create an instance of OrderList', function() {
      ...
      //var instane = new SellingPartnerApiForOrders.OrderList();
      //expect(instance).to.be.a(SellingPartnerApiForOrders.OrderList);
    });
