...
(function(root, factory) {
  ...
  describe('ListFinancialEventGroupsPayload', function() {
    it('should create an instance of ListFinancialEventGroupsPayload', function() {
      // uncomment below and update the code to test ListFinancialEventGroupsPayload
      //var instane = new SellingPartnerApiForFinances.ListFinancialEventGroupsPayload();
    ...
    it('should have the property financialEventGroupList (base name: "FinancialEventGroupList")', function() {
      // uncomment below and update the code to test the property financialEventGroupList
      //var instane = new SellingPartnerApiForFinances.ListFinancialEventGroupsPayload();
      //expect(instance).to.be();
    });
