...
(function(root, factory) {
  ...
  describe('FeesEstimate', function() {
    it('should create an instance of FeesEstimate', function() {
      // uncomment below and update the code to test FeesEstimate
      //var instane = new SellingPartnerApiForProductFees.FeesEstimate();
    ...
    it('should have the property timeOfFeesEstimation (base name: "TimeOfFeesEstimation")', function() {
      // uncomment below and update the code to test the property timeOfFeesEstimation
      //var instane = new SellingPartnerApiForProductFees.FeesEstimate();
      //expect(instance).to.be();
    });

    it('should have the property totalFeesEstimate (base name: "TotalFeesEstimate")', function() {
      // uncomment below and update the code to test the property totalFeesEstimate
      //var instane = new SellingPartnerApiForProductFees.FeesEstimate();
      //expect(instance).to.be();
    });

    it('should have the property feeDetailList (base name: "FeeDetailList")', function() {
      // uncomment below and update the code to test the property feeDetailList
      //var instane = new SellingPartnerApiForProductFees.FeesEstimate();
      //expect(instance).to.be();
    });
