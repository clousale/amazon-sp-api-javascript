...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForOrders.BuyerCustomizedInfoDetail();
  });
  ...
  describe('BuyerCustomizedInfoDetail', function() {
    it('should create an instance of BuyerCustomizedInfoDetail', function() {
      // uncomment below and update the code to test BuyerCustomizedInfoDetail
      //var instane = new SellingPartnerApiForOrders.BuyerCustomizedInfoDetail();
    ...
    it('should have the property customizedURL (base name: "CustomizedURL")', function() {
      // uncomment below and update the code to test the property customizedURL
      //var instane = new SellingPartnerApiForOrders.BuyerCustomizedInfoDetail();
