...
(function(root, factory) {
  ...
  describe('LabelSpecification', function() {
    it('should create an instance of LabelSpecification', function() {
      // uncomment below and update the code to test LabelSpecification
      //var instane = new SellingPartnerApiForShipping.LabelSpecification();
    ...
    it('should have the property labelStockSize (base name: "labelStockSize")', function() {
      // uncomment below and update the code to test the property labelStockSize
      //var instane = new SellingPartnerApiForShipping.LabelSpecification();
      //expect(instance).to.be();
    });
