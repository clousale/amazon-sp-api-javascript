...
(function(root, factory) {
  ...
  describe('InvalidASIN', function() {
    it('should create an instance of InvalidASIN', function() {
      // uncomment below and update the code to test InvalidASIN
      //var instane = new SellingPartnerApiForFulfillmentInbound.InvalidASIN();
