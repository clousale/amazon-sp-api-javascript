...
(function(root, factory) {
  ...
  describe('PrepOwner', function() {
    it('should create an instance of PrepOwner', function() {
      // uncomment below and update the code to test PrepOwner
      //var instane = new SellingPartnerApiForFulfillmentInbound.PrepOwner();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.PrepOwner);
    });
