...
(function(root, factory) {
  ...
  describe('ConditionType', function() {
    it('should create an instance of ConditionType', function() {
      // uncomment below and update the code to test ConditionType
      //var instane = new SellingPartnerApiForPricing.ConditionType();
      //expect(instance).to.be.a(SellingPartnerApiForPricing.ConditionType);
    });
