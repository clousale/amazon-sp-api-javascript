...
(function(root, factory) {
  ...
  describe('ShipmentStatus', function() {
    it('should create an instance of ShipmentStatus', function() {
      // uncomment below and update the code to test ShipmentStatus
      //var instane = new SellingPartnerApiForFulfillmentInbound.ShipmentStatus();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.ShipmentStatus);
    });
