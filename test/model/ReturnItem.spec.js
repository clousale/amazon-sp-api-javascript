...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.ReturnItem();
  });
  ...
  describe('ReturnItem', function() {
    it('should create an instance of ReturnItem', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentOutbound.ReturnItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.ReturnItem);
    });
