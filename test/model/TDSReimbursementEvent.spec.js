...
(function(root, factory) {
  ...
  describe('TDSReimbursementEvent', function() {
    it('should create an instance of TDSReimbursementEvent', function() {
      // uncomment below and update the code to test TDSReimbursementEvent
      //var instane = new SellingPartnerApiForFinances.TDSReimbursementEvent();
    ...
    it('should have the property tdsOrderId (base name: "TdsOrderId")', function() {
      // uncomment below and update the code to test the property tdsOrderId
      //var instane = new SellingPartnerApiForFinances.TDSReimbursementEvent();
      //expect(instance).to.be();
    });
