...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForSolicitations.Schema();
  });
  ...
  describe('Schema', function() {
    it('should create an instance of Schema', function() {
      ...
      //var instane = new SellingPartnerApiForSolicitations.Schema();
      //expect(instance).to.be.a(SellingPartnerApiForSolicitations.Schema);
    });
