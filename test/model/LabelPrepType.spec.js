...
(function(root, factory) {
  ...
  describe('LabelPrepType', function() {
    it('should create an instance of LabelPrepType', function() {
      // uncomment below and update the code to test LabelPrepType
      //var instane = new SellingPartnerApiForFulfillmentInbound.LabelPrepType();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.LabelPrepType);
    });
