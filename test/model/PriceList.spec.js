...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForPricing.PriceList();
  });
  ...
  describe('PriceList', function() {
    it('should create an instance of PriceList', function() {
      ...
      //var instane = new SellingPartnerApiForPricing.PriceList();
      //expect(instance).to.be.a(SellingPartnerApiForPricing.PriceList);
    });
