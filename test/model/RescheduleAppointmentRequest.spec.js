...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForServices.RescheduleAppointmentRequest();
  });
  ...
  describe('RescheduleAppointmentRequest', function() {
    it('should create an instance of RescheduleAppointmentRequest', function() {
      // uncomment below and update the code to test RescheduleAppointmentRequest
      //var instane = new SellingPartnerApiForServices.RescheduleAppointmentRequest();
    ...
    it('should have the property rescheduleReasonCode (base name: "rescheduleReasonCode")', function() {
      // uncomment below and update the code to test the property rescheduleReasonCode
      //var instane = new SellingPartnerApiForServices.RescheduleAppointmentRequest();
      //expect(instance).to.be();
    });
