...
(function(root, factory) {
  ...
  describe('LoanServicingEvent', function() {
    it('should create an instance of LoanServicingEvent', function() {
      // uncomment below and update the code to test LoanServicingEvent
      //var instane = new SellingPartnerApiForFinances.LoanServicingEvent();
    ...
    it('should have the property sourceBusinessEventType (base name: "SourceBusinessEventType")', function() {
      // uncomment below and update the code to test the property sourceBusinessEventType
      //var instane = new SellingPartnerApiForFinances.LoanServicingEvent();
      //expect(instance).to.be();
    });
