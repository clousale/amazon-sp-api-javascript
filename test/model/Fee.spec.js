...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.Fee();
  });
  ...
  describe('Fee', function() {
    it('should create an instance of Fee', function() {
      ...
      //var instane = new SellingPartnerApiForFulfillmentOutbound.Fee();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.Fee);
    });
