...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.UnfulfillablePreviewItem();
  });
  ...
  describe('UnfulfillablePreviewItem', function() {
    it('should create an instance of UnfulfillablePreviewItem', function() {
      // uncomment below and update the code to test UnfulfillablePreviewItem
      //var instane = new SellingPartnerApiForFulfillmentOutbound.UnfulfillablePreviewItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.UnfulfillablePreviewItem);
    });
    ...
    it('should have the property itemUnfulfillableReasons (base name: "ItemUnfulfillableReasons")', function() {
      // uncomment below and update the code to test the property itemUnfulfillableReasons
      //var instane = new SellingPartnerApiForFulfillmentOutbound.UnfulfillablePreviewItem();
      //expect(instance).to.be();
    });
