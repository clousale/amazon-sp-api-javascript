...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForServices.Warning();
  });
  ...
  describe('Warning', function() {
    it('should create an instance of Warning', function() {
      ...
      //var instane = new SellingPartnerApiForServices.Warning();
      //expect(instance).to.be.a(SellingPartnerApiForServices.Warning);
    });
