...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.CreateFulfillmentOrderItem();
  });
  ...
  describe('CreateFulfillmentOrderItem', function() {
    it('should create an instance of CreateFulfillmentOrderItem', function() {
      // uncomment below and update the code to test CreateFulfillmentOrderItem
      //var instane = new SellingPartnerApiForFulfillmentOutbound.CreateFulfillmentOrderItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.CreateFulfillmentOrderItem);
    });
