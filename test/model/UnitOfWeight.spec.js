...
(function(root, factory) {
  ...
  describe('UnitOfWeight', function() {
    it('should create an instance of UnitOfWeight', function() {
      // uncomment below and update the code to test UnitOfWeight
      //var instane = new SellingPartnerApiForFulfillmentInbound.UnitOfWeight();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.UnitOfWeight);
    });
