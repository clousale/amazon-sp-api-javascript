...
(function(root, factory) {
  ...
  describe('SellerFreightClass', function() {
    it('should create an instance of SellerFreightClass', function() {
      // uncomment below and update the code to test SellerFreightClass
      //var instane = new SellingPartnerApiForFulfillmentInbound.SellerFreightClass();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.SellerFreightClass);
    });
