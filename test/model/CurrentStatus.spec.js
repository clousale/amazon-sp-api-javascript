...
(function(root, factory) {
  ...
  describe('CurrentStatus', function() {
    it('should create an instance of CurrentStatus', function() {
      // uncomment below and update the code to test CurrentStatus
      //var instane = new SellingPartnerApiForFulfillmentOutbound.CurrentStatus();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.CurrentStatus);
    });
