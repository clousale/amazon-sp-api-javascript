...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellingPartnerApiForFulfillmentOutbound.GetFulfillmentPreviewItem();
  });
  ...
  describe('GetFulfillmentPreviewItem', function() {
    it('should create an instance of GetFulfillmentPreviewItem', function() {
      // uncomment below and update the code to test GetFulfillmentPreviewItem
      //var instane = new SellingPartnerApiForFulfillmentOutbound.GetFulfillmentPreviewItem();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentOutbound.GetFulfillmentPreviewItem);
    });
