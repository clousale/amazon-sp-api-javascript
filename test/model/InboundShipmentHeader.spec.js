...
(function(root, factory) {
  ...
  describe('InboundShipmentHeader', function() {
    it('should create an instance of InboundShipmentHeader', function() {
      // uncomment below and update the code to test InboundShipmentHeader
      //var instane = new SellingPartnerApiForFulfillmentInbound.InboundShipmentHeader();
    ...
    it('should have the property labelPrepPreference (base name: "LabelPrepPreference")', function() {
      // uncomment below and update the code to test the property labelPrepPreference
      //var instane = new SellingPartnerApiForFulfillmentInbound.InboundShipmentHeader();
      //expect(instance).to.be();
    });

    it('should have the property intendedBoxContentsSource (base name: "IntendedBoxContentsSource")', function() {
      // uncomment below and update the code to test the property intendedBoxContentsSource
      //var instane = new SellingPartnerApiForFulfillmentInbound.InboundShipmentHeader();
      //expect(instance).to.be();
    });
