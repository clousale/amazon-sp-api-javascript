...
(function(root, factory) {
  ...
  describe('GuidanceReason', function() {
    it('should create an instance of GuidanceReason', function() {
      // uncomment below and update the code to test GuidanceReason
      //var instane = new SellingPartnerApiForFulfillmentInbound.GuidanceReason();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.GuidanceReason);
    });
