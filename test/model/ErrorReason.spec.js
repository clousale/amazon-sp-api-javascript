...
(function(root, factory) {
  ...
  describe('ErrorReason', function() {
    it('should create an instance of ErrorReason', function() {
      // uncomment below and update the code to test ErrorReason
      //var instane = new SellingPartnerApiForFulfillmentInbound.ErrorReason();
      //expect(instance).to.be.a(SellingPartnerApiForFulfillmentInbound.ErrorReason);
    });
