...
export default class ItemList extends Array {
    ...
    * @alias module:client/models/ItemList
    * @class
    * @extends Array
    */
    ...
    * @param {module:client/models/ItemList} obj Optional instance to populate.
    * @return {module:client/models/ItemList} The populated <code>ItemList</code> instance.
    */
