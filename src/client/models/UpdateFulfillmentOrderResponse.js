...
* @module client/models/UpdateFulfillmentOrderResponse
* @version v0
*/
export default class UpdateFulfillmentOrderResponse {
    /**
    * Constructs a new <code>UpdateFulfillmentOrderResponse</code>.
    * The response schema for the updateFulfillmentOrder operation.
    * @alias module:client/models/UpdateFulfillmentOrderResponse
    * @class
    */
    ...
    * @param {module:client/models/UpdateFulfillmentOrderResponse} obj Optional instance to populate.
    * @return {module:client/models/UpdateFulfillmentOrderResponse} The populated <code>UpdateFulfillmentOrderResponse</code> instance.
    */
