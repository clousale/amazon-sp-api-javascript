...
* @module client/models/GetSchemaResponseLinks
* @version v1
*/
export default class GetSchemaResponseLinks {
    /**
    * Constructs a new <code>GetSchemaResponseLinks</code>.
    * @alias module:client/models/GetSchemaResponseLinks
    * @class
    ...
    * @param {module:client/models/GetSchemaResponseLinks} obj Optional instance to populate.
    * @return {module:client/models/GetSchemaResponseLinks} The populated <code>GetSchemaResponseLinks</code> instance.
    */
